	...
	<body>
		...
		<div class="container panel-margin">
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/c1.jpeg" alt="camera">
						<div class="caption">
							<h3>Nikon DSLR</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/c3.jpeg" alt="camera">
						<div class="caption">
							<h3>Olympus DSLR</h3>
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/dress.jpg" alt="shirt">
						<div class="caption">
							<h3>Blue Dress</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="images/pink.jpeg" alt="shirt">
						<div class="caption">
							<h3>pink dress</h3>
							<p>Price: <i class="fa fa-rupee"></i> 700</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/grey.jpeg" alt="shirt">
						<div class="caption">
							<h3>grey dress</h3>
							<p>Price: <i class="fa fa-rupee"></i> 700</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/red lehenga.jpeg" alt="shirt">
						<div class="caption">
							<h3>Red lehenga</h3>
							<p>Price: <i class="fa fa-rupee"></i> 700</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
